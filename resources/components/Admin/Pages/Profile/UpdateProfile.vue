...
<template>
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <div class="text-center">
                    <input @change="handelFileInput" ref="fileInput" type="file" class="d-none">
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="changePassword">
                        <form @submit.prevent ='handelFormPassword' class="form-horizontal">
                            <div class="form-group row">
   ...
   <Preloader v-if="!authUserStore.user.name" :loading = "loading" />
   </template>
<style>
.profile-user-img {
...
.profile-user-img:hover {
    border-color: #ff0000; /* New border color on hover */
}
</style>
